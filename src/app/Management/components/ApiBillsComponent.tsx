...
const ApiBillsComponent: React.FC = () => {
  ...
  const apiOptions = Array.from(new Set(services.map(s => s.service)));
        ...
        <div className={`lg:w-1/4 ${isFilterOpen ? 'block' : 'hidden'} lg:block`}>
          <div className="bg-white shadow-sm p-2 md:p-6 border border-gray-200">
            ...
            <div className="space-y-2 md:space-y-6">
              {/* Service Provider Filter - from service.json name field */}
              <div>
              ...
              {/* API Filter - from service.json service field */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">API / Service Name</label>
                <select 
                  className="w-full border border-gray-300 px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white"
