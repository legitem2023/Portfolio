...
const DeluxeNavTabs: React.FC = () => {
  ...
  return (
    <div className="w-full mx-auto font-sans z-10">
      <div className="fixed bg-violet-50 md:static bottom-0 left-0 right-0 w-full flex justify-between md:justify-center overflow-x-auto hide-scrollbar z-30 md:z-20 md:mb-1">
