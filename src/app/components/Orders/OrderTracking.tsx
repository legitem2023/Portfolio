      ...
      <div className="p-3 sm:p-4 md:p-5">
        ...
        <div className="space-y-2 text-xs sm:text-sm mb-3 sm:mb-4">
          ...
          <div className="flex justify-between">
            ...
            <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${stage?.color} ${stage?.textColor}`}>
              {stage?.label}
            </span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-t-2xl sm:rounded-2xl shadow-2xl w-full h-[90vh] sm:h-auto sm:max-h-[90vh] sm:max-w-4xl flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto p-3 sm:p-4 md:p-6 space-y-3 sm:space-y-4 md:space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-6">
              ...
              <section className="bg-white border border-purple-200 rounded-lg p-3 sm:p-4 md:p-6">
                ...
                <div className="space-y-2 sm:space-y-3 md:space-y-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-sm sm:text-base">{formatPesoPrice(order.total)}</span>
                  </div>
                  <div className="border-t border-gray-200 pt-2 sm:pt-3 md:pt-4 flex justify-between text-base sm:text-lg md:text-xl font-bold text-purple-900">
                    <span className="text-sm sm:text-base md:text-lg">Grand Total:</span>
              ...
              {/* Order Information */}
              <section className="bg-white border border-purple-200 rounded-lg p-3 sm:p-4 md:p-6">
                <h3 className="text-base sm:text-lg font-semibold text-purple-900 mb-2 sm:mb-3 md:mb-4">Order Information</h3>
                <div className="space-y-2 sm:space-y-3 md:space-y-4">
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className={`px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-xs sm:text-sm font-medium ${stage?.color} ${stage?.textColor}`}>
                      {stage?.label}
                    </span>
                  </div>
                  <div className="flex justify-between">
            ...
            {order.address && (
              <section className="bg-white border border-purple-200 rounded-lg p-3 sm:p-4 md:p-6">
                <h3 className="text-base sm:text-lg font-semibold text-purple-900 mb-2 sm:mb-3 md:mb-4">Shipping Address</h3>
...
function OrderError({ error }: { error: any }) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-red-100 p-2 sm:p-4 flex items-center justify-center">
      <div className="max-w-md mx-auto text-center">
        <div className="bg-white rounded-lg shadow-xl p-6 sm:p-8">
          <div className="text-5xl sm:text-6xl mb-4">⚠️</div>
          <h2 className="text-xl sm:text-2xl font-bold text-red-600 mb-2">Error Loading Orders</h2>
          <p className="text-gray-600 mb-4">There was a problem fetching your orders.</p>
          <p className="text-sm text-gray-500 bg-gray-50 p-3 rounded-lg break-words">
