...
const Threejs = () => {
    ...
    useEffect(() => {
        ...
        Manager.Loadmodel(`https://hokei-storage.s3.ap-northeast-1.amazonaws.com/images/Legit/model_houses/the_mansion.glb`, camera, scene);
        ...
        const material = new THREE.MeshBasicMaterial({ color: 0xc0c0c0, map: texture,side: THREE.DoubleSide});
