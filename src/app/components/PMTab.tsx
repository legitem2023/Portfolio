                    ...
                    return (
                      <div key={user.id} className="relative group">
                        ...
                        <button
                          ...
                          className="absolute right-12 top-1/2 transform -translate-y-1/2 p-2 bg-purple-100 text-purple-600 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300 hover:scale-110 hover:bg-purple-200"
                    ...
                    <div className="z-20 flex items-center justify-between p-2 h-[100%] w-[100%]">
                      ...
                      <div className="flex space-x-2 flex-shrink-0">
                        ...
                        <button 
                          ...
                          className="p-2 text-purple-600 hover:text-purple-800 transition-all duration-300 hover:scale-110 bg-purple-100 rounded-full hover:bg-purple-200"
                          title="Start video call"
                        >
