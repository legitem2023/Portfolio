...
const Footer = () => {
  return (
    <footer className="z-20 mb-10 bg-violet-50 text-purple-900 pt-16 pb-8 px-4 sm:pb-50">
...
<div className="flex space-x-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/Privacy" className="text-indigo-600 hover:text-white">Privacy</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center text-indigo-600">
                ...
                <span>vendorcity2026@gmail.com</span>
              </li>
              <li className="flex items-center text-indigo-600">
