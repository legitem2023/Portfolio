  ...
  return (
    <header className="relative">
      ...
      <div className="bg-gray-100 py-2 px-4 border-b border-gray-200">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between text-xs text-gray-600">
          <div className="flex items-center mb-1 md:mb-0">
            <span className="font-medium mr-1">Total Visits:</span>
            <span>24,589</span>
          </div>
          
          <div className="flex items-center mb-1 md:mb-0">
            <span className="font-medium mr-1">Store Rating:</span>
