      ...
      <div className="p-2 lg:p-6">
        ...
        <div className="flex justify-between items-start mb-3 lg:mb-4">
          ...
          <div className="text-right">
            <div className="text-xl lg:text-3xl font-bold text-green-600">{formatPeso(payout)}</div>
            <p className="text-gray-500 text-xs lg:text-sm">Total shipping payout</p>
            {delivery.subtotal && (
          ...
          {showItems && (
            <div className="px-2 sm:px-3 lg:px-4 pb-2 sm:pb-3 lg:pb-4 space-y-2 sm:space-y-3 border-t border-gray-200 pt-2 sm:pt-3">
              ...
              <div className="flex flex-col xs:flex-row justify-between items-start xs:items-center gap-2 bg-orange-50 rounded-lg p-3 sm:p-4 mt-2 sm:mt-3">
                <span className="text-sm sm:text-base font-medium text-gray-600">Total shipping payout for this supplier</span>
