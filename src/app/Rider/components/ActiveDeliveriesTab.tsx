...
const ACTIVE_TAB_STORAGE_KEY = 'activeDeliveriesTab';
...
export default function ActiveDeliveriesTab({ isMobile }: ActiveDeliveriesTabProps) {
  ...
  const [activeTab, setActiveTab] = useState(() => {
    if (typeof window !== 'undefined') {
      ...
      // Validate that savedTab is a valid status
      if (savedTab && (savedTab === 'PROCESSING' || savedTab === 'SHIPPED' || savedTab === 'DELIVERED')) {
        return savedTab;
      }
    }
    return "PROCESSING";
