      ...
      <div className="bg-white rounded-lg shadow-lg border border-indigo-200 overflow-hidden">
        ...
        <div className="p-2 lg:p-6">
                  ...
                  <div key={item.id} className="flex justify-between text-xs lg:text-sm">
                    <div className="flex-1"> 
                      <div className="flex items-center gap-2 mt-1">
                        <span className="text-gray-400 text-xs">SKU: {item.product.sku}</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 lg:gap-4 mb-4 lg:mb-6">
            <div className="bg-blue-50 p-2 lg:p-3 rounded-lg relative">
              <div className="flex items-center justify-between mb-1 lg:mb-2">
                ...
                <button
                  ...
                  className="text-blue-600 hover:text-blue-800 text-xs flex items-center gap-1 bg-blue-100 px-2 py-1 rounded-full transition-colors"
                >
                  <Navigation size={12} />
